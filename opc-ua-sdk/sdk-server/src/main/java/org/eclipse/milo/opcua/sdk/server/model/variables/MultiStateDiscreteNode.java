...
import org.eclipse.milo.opcua.sdk.core.model.variables.MultiStateDiscreteType;
...
public class MultiStateDiscreteNode extends DiscreteItemNode implements MultiStateDiscreteType {
    ...
    public LocalizedText[] getEnumStrings() {
        Optional<LocalizedText[]> property = getProperty(MultiStateDiscreteType.ENUM_STRINGS);
    ...
    public PropertyNode getEnumStringsNode() {
        Optional<VariableNode> propertyNode = getPropertyNode(MultiStateDiscreteType.ENUM_STRINGS.getBrowseName());
