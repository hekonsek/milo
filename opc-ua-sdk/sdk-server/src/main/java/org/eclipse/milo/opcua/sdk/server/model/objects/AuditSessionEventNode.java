...
import org.eclipse.milo.opcua.sdk.core.model.objects.AuditSessionEventType;
...
public class AuditSessionEventNode extends AuditSecurityEventNode implements AuditSessionEventType {
    ...
    public NodeId getSessionId() {
        Optional<NodeId> property = getProperty(AuditSessionEventType.SESSION_ID);
    ...
    public PropertyNode getSessionIdNode() {
        Optional<VariableNode> propertyNode = getPropertyNode(AuditSessionEventType.SESSION_ID.getBrowseName());
